...
class DataFrameCSV():
    ...
    def __init__(self, sample_data_dir: str, load_file_backup_dir: str, worksheet_name: str, contributor_name: str):
...
class DataFrameTable(DataFrameCSV):
    ...
    def __init__(self, sample_data_dir: str, load_file_backup_dir: str, worksheet_name: str, contributor_name: str):
        super().__init__(sample_data_dir, load_file_backup_dir, worksheet_name, contributor_name)
