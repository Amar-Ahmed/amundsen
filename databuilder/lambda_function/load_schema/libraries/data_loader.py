...
class Data_Loader:
    ...
    def run_csv_job(self, file_loc, job_name, model):
        ...
        job_config = ConfigFactory.from_dict({
            ...
            'publisher.neo4j.neo4j_endpoint': self._neo4j_endpoint,
            'publisher.neo4j.neo4j_user': self._neo4j_user,
            'publisher.neo4j.neo4j_password': self._neo4j_password,
    ...
    def create_dashboard_tables_job(self, dashboard_file_path: str):
        ...
        publisher = Neo4jCsvPublisher()
        job_config = ConfigFactory.from_dict({
            f'{csv_extractor.get_scope()}.file_location': dashboard_file_path,
            f'{transformer.get_scope()}.{generic_transformer.get_scope()}.{FIELD_NAME}': 'table_ids',
            f'{transformer.get_scope()}.{generic_transformer.get_scope()}.{CALLBACK_FUNCTION}': Data_Loader._str_to_list,
            ...
            f'{publisher.get_scope()}.neo4j_endpoint': self._neo4j_endpoint,
            f'{publisher.get_scope()}.neo4j_user': self._neo4j_user,
            f'{publisher.get_scope()}.neo4j_password': self._neo4j_password,
    ...
    def create_es_publisher_sample_job(self, elasticsearch_index_alias='table_search_index',
        ...
        elasticsearch_client = self._elastic_search
        ...
        job_config = ConfigFactory.from_dict({
            ...
            'extractor.search_data.extractor.neo4j.graph_url': self._neo4j_endpoint,
            'extractor.search_data.extractor.neo4j.model_class': model_name,
            'extractor.search_data.extractor.neo4j.neo4j_auth_user': self._neo4j_user,
            'extractor.search_data.extractor.neo4j.neo4j_auth_pw': self._neo4j_password,
    ...
    def run_data_loader(self, schema: str):
        ...
        self.run_csv_job(
            f'{self._folder_name}/tmp/data_table_programmatic_source.csv', 
